...
from recommenders import recommend_nmf,recommend_col
...
##########################################################
    ...
    if recommend_button:
        if recommender == 'NMF Recommender':
            # Perform recommendation using NMF model
            recommended_movies = recommend_nmf(user_query, NMF_MODEL,k=10)
        else:
                # Perform recommendation using Distance model
            recommended_movies = recommend_col(user_query,DISTANCE_MODEL,k=4)
